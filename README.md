...
> el puerto 8007 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                 STATUS                    PORTS
> proyecto_paradigmas5-api-facturas-1   Up 2 hours                0.0.0.0:8007->8007/tcp
> proyecto_paradigmas5-postgres-1       Up 2 hours (healthy)      0.0.0.0:15437->5432/tcp
> ```
>
...
| Qué | Dónde |
|---|---|
| **EL FRONT** (lo que ve el usuario) | http://localhost:8008 |
| **API Facturas — Swagger** (probar los endpoints) | http://localhost:8007/docs |
| Diagnóstico | http://localhost:8007/ |
| PostgreSQL (para DBeaver/pgAdmin, opcional) | `localhost:15437` · `paradigmas`/`paradigmas123` |
...
http://localhost:8008, edite un producto, bórrele el nombre y oprima los
...
│
├── front_flask/                 # EL FRONT DE LA v5 — Flask + Jinja2 (puerto 8008)
...
│   ├── templates/               # Jinja2: base.html + las pantallas de producto
...
│
├── api_facturas/                # LA API DE LA v1 — FastAPI (puerto 8007)
...
v5  el FRONT nace: Flask consume la API por HTTP
    y no toca la base   ← USTED ESTÁ AQUÍ
v6  el front cubre las otras cinco entidades
```
...
| [2_spec.md](docs/spec_kit/versiones/v5_front/2_spec.md) | QUÉ construir y los **7 criterios de aceptación** |
| [3_plan.md](docs/spec_kit/versiones/v5_front/3_plan.md) | CÓMO: la arquitectura del front y el chequeo de constitución |
| [4_research.md](docs/spec_kit/versiones/v5_front/4_research.md) | Las decisiones: por qué no hay login, y por qué el front no valida |
| [5_data_model.md](docs/spec_kit/versiones/v5_front/5_data_model.md) | **El front no tiene datos propios** — y eso es el punto |
| [6_contracts.md](docs/spec_kit/versiones/v5_front/6_contracts.md) | Las PANTALLAS: cuatro rutas y a qué endpoint llama cada una |
| [7_quickstart.md](docs/spec_kit/versiones/v5_front/7_quickstart.md) | Arranque, smoke test y la regresión de la API v1–v4 |
| [8_tasks.md](docs/spec_kit/versiones/v5_front/8_tasks.md) | Las 8 fases, cada una con su verificación |
| [9_checklist.md](docs/spec_kit/versiones/v5_front/9_checklist.md) | **La compuerta 3**: se firma ANTES de programar |
| [GUIA_IA5.md](docs/spec_kit/versiones/v5_front/GUIA_IA5.md) | Construir la versión con IA, con el prompt listo |
