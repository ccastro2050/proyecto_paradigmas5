...
CAPA 2: API (FastAPI)        — api_facturas :8007
...
| Cosa | Convención |
|---|---|
| Puertos públicos | front 8000 · · api_facturas 8007 · phpMyAdmin 8081 |
| Puertos de BD hacia el host | PostgreSQL **15437** · MariaDB **13306** · SQL Server **11433** (desplazados para no chocar con motores locales) |
| Hosts internos (entre contenedores) | `postgres:5432` · `mariadb:3306` · `sqlserver:1433` · `api-facturas:8007` |
