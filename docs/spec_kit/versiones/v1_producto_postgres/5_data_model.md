...
```
# API corriendo LOCAL (venv + uvicorn), la BD publica el puerto 15437 al host:
postgresql+asyncpg://paradigmas:paradigmas123@localhost:15437/bdfacturas_postgres_local
