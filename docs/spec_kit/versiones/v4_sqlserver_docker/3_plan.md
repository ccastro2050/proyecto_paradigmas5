...
| Archivo | Qué crece |
|---|---|
| `docker-compose.yml` | ★ `sqlserver` (2022, :11436, healthcheck con sqlcmd) + `sqlserver-init` + `DB_SQLSERVER` y el tercer valor de `DB_PROVIDER` |
...
- Puertos publicados: 8007 (API) · 15437 (postgres) · 13336 (mariadb) ·
  **11436 (sqlserver)**. Reconstrucción del estudiante: +100.
