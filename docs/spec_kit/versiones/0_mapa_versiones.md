...
| **v5** | [v5_front/](v5_front/2_spec.md) — **Cerrada** (tag `v5`) | Se suma el **frontend Flask** (puerto 8008) que consume la API: las pantallas de producto | Separación de capas a nivel de SISTEMA; el front no toca la BD |
