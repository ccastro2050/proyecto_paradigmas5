...
| Archivo | Qué crece |
|---|---|
| `docker-compose.yml` | ★ servicio `mariadb` (11, puerto 13336, se inicializa solo) + `DB_MARIADB` y `DB_PROVIDER: ${DB_PROVIDER:-postgres}` en la API |
...
- Puerto publicado **13336** (libre en el mapa del curso; la
