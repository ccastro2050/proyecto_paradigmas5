...
flowchart LR
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15437"| POSTGRES
    NAV -.->|"opcional (diagnóstico):<br/>localhost:13336"| MARIADB
    NAV -.->|"opcional (diagnóstico):<br/>localhost:11436"| SQLSERVER
```
