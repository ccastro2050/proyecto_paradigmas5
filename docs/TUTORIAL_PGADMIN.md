...
> Dato importante: la BD del contenedor publica el puerto **15437** en su PC
...
| Port | `15437` | El puerto publicado (no el 5432 clásico, para no chocar con un PostgreSQL local) |
...
Abra en el navegador: **http://localhost:8007/api/producto/PR001**
...
- pgAdmin se conecta al puerto **15437** (el publicado por el compose). Si no
